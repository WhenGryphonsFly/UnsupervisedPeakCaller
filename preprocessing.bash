...
helpFunction()
{
   ...
   echo -e "\t-m Bam files merged from individual replicate. Only used for preprocessing purpose, not for calling peaks. Must be indexed and sorted."
   echo -e "\t-b Individual bam files of every replicates. Must be indexed and sorted."
...
if [[ $genome == "hg" ]] || [[ $genome == "mm" ]] || [[ $genome == "danRer" ]]
then
	for i in $chrList
	do
